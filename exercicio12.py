...
valorHora = float(input(' valor  trabalho/hora: '))
quantidadeHora =float(input('Quantidade de horas trabalhadas no mês: '))
salarioBruto = valorHora*quantidadeHora
#variáveis que guardam calculo de descontos e fgts:
